...
<body class="antialiased bg-[#FAF7F2] text-[#171717]">
    ...
    <div class="min-h-screen w-full flex">
        ...
        <div class="hidden lg:flex lg:w-[46%] relative overflow-hidden
            ...
            <div class="absolute inset-y-0 right-0 w-px bg-gradient-to-b from-transparent via-blue-300/50 to-transparent"></div>
            ...
            <div class="relative z-10 flex flex-col justify-between w-full px-12 py-14 text-white">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="leading-tight">
                        <p class="text-[11px] tracking-[0.2em] text-blue-200 font-semibold">PT DAGSAP ENDURA EATORE</p>
                        <p class="text-[11px] text-white/60">Rerum Concordia Endura</p>
                    </div>
                </div>

                <div class="my-auto py-16">
                    <p class="uppercase tracking-[0.25em] text-xs text-blue-200 font-semibold mb-5">
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-12 sm:px-10 relative">
            ...
            <div class="pointer-events-none absolute inset-0 lg:hidden overflow-hidden">
                <div class="absolute -top-20 -right-24 w-72 h-72 bg-blue-600/[0.06] rounded-full blur-3xl"></div>
                <div class="absolute -bottom-24 -left-16 w-72 h-72 bg-blue-300/[0.10] rounded-full blur-3xl"></div>
            </div>
            ...
            <div class="relative w-full max-w-sm">
                ...
                <div class="flex lg:hidden flex-col items-center text-center mb-10">
                    ...
                    <p class="text-[11px] tracking-[0.2em] text-blue-600 font-bold">PT DAGSAP ENDURA EATORE</p>
                </div>

                <div class="bg-white rounded-2xl border border-[#E5EAF5] shadow-[0_20px_50px_-15px_rgba(37,99,235,0.18)]
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 border border-[#E5E5E5] rounded-xl px-4 py-3
                                        bg-[#FAFAFA] focus-within:bg-white focus-within:border-blue-600
                                        focus-within:ring-2 focus-within:ring-blue-600/15 transition-all">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3 border border-[#E5E5E5] rounded-xl px-4 py-3
                                        bg-[#FAFAFA] focus-within:bg-white focus-within:border-blue-600
                                        focus-within:ring-2 focus-within:ring-blue-600/15 transition-all" x-data="{ show: false }">
                                <svg class="w-[18px] h-[18px] text-[#A3A3A3] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                ...
                                <button type="button" @click="show = !show" aria-label="Toggle password visibility"
                                        class="shrink-0 text-[#A3A3A3] hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 rounded">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <label for="remember" class="flex items-center gap-2 cursor-pointer select-none">
                                <input id="remember" type="checkbox" name="remember"
                                       class="w-4 h-4 rounded border-[#D4D4D4] text-blue-600 focus:ring-blue-600/30">
                        ...
                        {{-- Submit --}}
                        <button type="submit"
                                class="w-full py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700
                                       hover:from-blue-700 hover:to-blue-800 text-white text-sm font-semibold
                                       tracking-wide shadow-lg shadow-blue-600/25 transition-all

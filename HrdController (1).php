...
class HrdController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $officialReadyCount = $officials->filter(function ($official) use ($tahun) {
            return $official->feedbacks_received_count >= User::MIN_TANGGAPAN_KORELASI
                ...
                // lihat officialPdf().
                && $official->official_evaluation_hrd_signed_count > 0;
        })->count();
    ...
    public function storeAccount(Request $request)
    {
        $validated = $request->validate([
            ...
            'tanggapan_atasan_manual' => 'nullable|boolean',
            'supervisor_id' => [
                'nullable',
        ...
        User::create([
            ...
            // Tanggapan Atasan manual cuma relevan buat pegawai, sama
            // seperti is_spg.
            'tanggapan_atasan_manual' => $validated['role'] === 'pegawai'
                && !empty($validated['tanggapan_atasan_manual']),
    ...
    public function importAccounts(Request $request)
    {
        ...
        try {
            ...
            foreach ($spreadsheet->getWorksheetIterator() as $sheet) {
                ...
                $menitTerlambat = isset($columnIndex['menit_terlambat'])
                    ? (int) ($cell('menit_terlambat') ?: 0)
                    : null;
    ...
    public function pdf(Request $request, $id)
    {
        ...
        // Kalau pegawai ini ditandai "Tanggapan Atasan manual"
        // (tanggapan_atasan_manual), HRD tetap boleh cetak PDF walau
        // atasan belum mengisi tanggapannya lewat sistem - atasan akan
